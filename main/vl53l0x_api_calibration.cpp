...
#include "vl53l0x_api_core.h"           // Pour VL53L0X_get_info_from_device
#include "vl53l0x_register_map.h"       // Pour toutes les constantes VL53L0X_REG_...
				...
				uint8_t *isApertureSpads)
{
	...
	for (index = 0; index < spadArraySize; index++)
		((VL53L0X_Dev_t*)Dev)->Data.SpadData.RefSpadEnables[index] = 0;
	...
	if (Status == VL53L0X_ERROR_NONE) {
		...
		Status = enable_ref_spads(Dev,
					needAptSpads,
					((VL53L0X_Dev_t*)Dev)->Data.SpadData.RefGoodSpadMap,
					((VL53L0X_Dev_t*)Dev)->Data.SpadData.RefSpadEnables,
					spadArraySize,
					startSelect,
					currentSpadIndex,
					minimumSpadCount,
	...
	if ((Status == VL53L0X_ERROR_NONE) &&
		...
		memcpy(lastSpadArray, ((VL53L0X_Dev_t*)Dev)->Data.SpadData.RefSpadEnables,
				spadArraySize);
