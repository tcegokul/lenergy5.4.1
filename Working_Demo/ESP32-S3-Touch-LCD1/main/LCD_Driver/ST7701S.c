...
esp_err_t ST7701S_reset(void)
{
    ...
    gpio_set_direction(RESET_GPIO_PIN, GPIO_MODE_OUTPUT_OD);
    gpio_set_level(RESET_GPIO_PIN, true);
    vTaskDelay(pdMS_TO_TICKS(10));
    gpio_set_level(RESET_GPIO_PIN, false);
    vTaskDelay(pdMS_TO_TICKS(50));
    gpio_set_level(RESET_GPIO_PIN, true);
    vTaskDelay(pdMS_TO_TICKS(50));
    return ESP_OK;
}
#define CS_GPIO_PIN  18
esp_err_t ST7701S_CS_EN(void)
{
    gpio_reset_pin(CS_GPIO_PIN);
    gpio_set_direction(CS_GPIO_PIN, GPIO_MODE_OUTPUT_OD);
    gpio_set_level(RESET_GPIO_PIN, false);
    vTaskDelay(pdMS_TO_TICKS(10));
    gpio_set_level(RESET_GPIO_PIN, true);
    vTaskDelay(pdMS_TO_TICKS(50));
